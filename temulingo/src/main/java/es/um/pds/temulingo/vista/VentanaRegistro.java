...
/**
 * Ventana de registro para la aplicación Temulingo.
 * Permite registrar nuevos usuarios con su respectivo username y seleccionar su de tipo de usuario.
 */
public class VentanaRegistro extends JFrame {
    ...
    private void register() {
        ...
        // Guardar el usuario (Esto lo he hecho para probar si funcionaria así pero vamos que ni idea)
        try {
            ...
            JOptionPane.showMessageDialog(this, 
                "¡Registro exitoso! Ya puedes iniciar sesión como " + userType, 
